...
const roadmap = [
  {
    ...
    details: ['Incorporation, structure légale et gouvernance', 'Dépôt programmes gouvernementaux) et subventions innovation)', 'Achat GPU, Jetson, capteurs et mise en place pipeline données']
  },
  {
    period: 'Déc. 2025',
